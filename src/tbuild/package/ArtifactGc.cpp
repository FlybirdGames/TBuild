...
namespace toolkit
{
                                  ...
                                  DiagnosticSink &diagnostics)
    {
        ...
        const auto artifactsRoot = workspaceRoot / ".tbuild" / "artifacts";
                                    ...
                                    DiagnosticSink &diagnostics)
    {
        ...
        const auto buildRoot = workspaceRoot / ".tbuild" / "build-packages";
                                     ...
                                     DiagnosticSink &diagnostics)
    {
        ...
        const auto packagesRoot = workspaceRoot / ".tbuild" / "packages";
