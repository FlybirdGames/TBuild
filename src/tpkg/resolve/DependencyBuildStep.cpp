#include "tpkg/resolve/DependencyBuildStep.hpp"
...
#include "tpkg/package/CMakePackageBuilder.hpp"
#include "tpkg/package/ConfigureMakePackageBuilder.hpp"
...
#include "tpkg/package/PrebuiltPackageBuilder.hpp"
...
namespace toolkit
{
                       ...
                       DiagnosticSink &diagnostics)
    {
        ...
        result.artifactDir = context.workspaceRoot / ".tpkg" / "artifacts" / result.updated.artifactId;
    ...
    {
        std::set<std::string> keys{currentPkgKey};
    ...
    void DepBuild::removeSiblings(const PackageCache &cache,
                                  ...
                                  DiagnosticSink &diagnostics)
    {
        const auto buildRoot = cache.build(dependency, currentPkgKey).parent_path();
        std::error_code ec;
    ...
    {
        return File::exists(buildDir / ".tpkg_build_complete");
    }
