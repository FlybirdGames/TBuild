...
function(_tpkg_first_existing out_var)
...
function(_tpkg_latest_child out_var parent)
...
function(_tpkg_msvc_host_arch out_var)
...
function(_tpkg_enable_msvc_ninja_sdk_paths)
    ...
    _tpkg_first_existing(_kits_root
        "C:/Windows Kits/10"
        "C:/Program Files (x86)/Windows Kits/10"
        "C:/Program Files/Windows Kits/10"
    )
    _tpkg_latest_child(_kits_version_root "${_kits_root}/Include")
    if(_kits_version_root)
        get_filename_component(_kits_version "${_kits_version_root}" NAME)
    endif()

    _tpkg_msvc_host_arch(_arch)
    ...
    message(STATUS "Toolkit Package Manager: added MSVC SDK include paths for Ninja from ${_vc_tools_root}")
    if(_kits_version)
        message(STATUS "Toolkit Package Manager: added Windows SDK ${_kits_version} paths from ${_kits_root}")
    endif()
endfunction()

_tpkg_enable_msvc_ninja_sdk_paths()
