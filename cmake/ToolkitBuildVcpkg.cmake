...
if(NOT DEFINED VCPKG_TARGET_TRIPLET OR VCPKG_TARGET_TRIPLET STREQUAL "")
    if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows")
        ...
        message(STATUS "ToolkitBuild: defaulting vcpkg triplet to ${VCPKG_TARGET_TRIPLET}")
    endif()
endif()

if(DEFINED VCPKG_TARGET_TRIPLET)
    set_property(CACHE VCPKG_TARGET_TRIPLET PROPERTY HELPSTRING "Optional vcpkg target triplet, such as x64-windows-static, x64-linux, arm64-osx. If unset, ToolkitBuild uses static vcpkg libraries on Windows.")
endif()
...
if(NOT DEFINED CMAKE_TOOLCHAIN_FILE OR CMAKE_TOOLCHAIN_FILE STREQUAL "")
    ...
    foreach(_tkb_vcpkg_root IN LISTS _tkb_vcpkg_candidates)
        if(EXISTS "${_tkb_vcpkg_root}/scripts/buildsystems/vcpkg.cmake")
            ...
            message(STATUS "ToolkitBuild: using vcpkg at ${TKB_VCPKG_ROOT}")
            break()
        endif()
    endforeach()
endif()
...
if(NOT DEFINED CMAKE_TOOLCHAIN_FILE OR CMAKE_TOOLCHAIN_FILE STREQUAL "")
    message(FATAL_ERROR
        "ToolkitBuild requires vcpkg manifest mode for third-party dependencies, but no vcpkg toolchain was found.\n"
