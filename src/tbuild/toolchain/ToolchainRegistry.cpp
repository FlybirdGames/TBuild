...
namespace toolkit
{
    ...
    {
        return workspaceRoot / ".tbuild" / "local.toml";
    }
    ...
    {
        return workspaceRoot / ".tbuild" / "toolchains" / "user.toml";
    }

    std::filesystem::path globalUserToolchainsPath()
    {
        return homePath() / ".tbuild" / "toolchains.toml";
    }
    ...
    {
        return {
            {ToolchainSource::AutoDetected, workspaceRoot / ".tbuild" / "toolchains" / "host.toml"},
